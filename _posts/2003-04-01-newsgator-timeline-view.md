...
tags: []
---
I'm usually not one to just post other people's stuff verbatim, but [this post](http://www.phoenixtrap.com/~mjg/index.php/2003_04_01_archive.xml#91791656) from [Mark Gardner](http://www.phoenixtrap.com/~mjg/) is just too cool for words:
...
>
> *Most other news aggregators I've tried don't have the flexibility of views that Outlook+NewsGator offers. It's true you could use a simple table view to get the now-ubiquitous* [*three-paned interface*](http://www.newsgator.com/ShowImage.aspx?url=ss_normal.gif)*, but that just doesn't cut it when you start subscribing to hundreds of feeds at a time.*
