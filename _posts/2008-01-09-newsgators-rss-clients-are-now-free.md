...
First, we've got new releases of our most popular applications: [FeedDemon 2.6](http://www.newsgator.com/Individuals/FeedDemon/Default.aspx), [NetNewsWire 3.1](http://www.newsgator.com/Individuals/NetNewsWire/Default.aspx), [Inbox 3.0 (beta)](http://www.newsgator.com/Individuals/NewsGatorInbox/Default.aspx), and [NewsGator Go! for Windows Mobile 2.0](http://www.newsgator.com/Individuals/NewsGatorGo/Default.aspx). Each of these is a pretty major release on its own - tons of new features in all of them.

But second, every one of those applications is now free! Free as in beer, that is. And add to the free list [NewsGator Go! for BlackBerry](http://www.newsgator.com/Individuals/NewsGatorGo/Default.aspx) as well. And not only are they free, but our online services (including synchronization) are now free as well! Not to mention our [iPhone reader](http://m.newsgator.com), [HTML mobile reader](http://m.newsgator.com), and all of the other applications that are part of our online platform.
...
[Press release](http://www.newsgator.com/CompanyInfo/Press/Archive.aspx?post=144)

[Q&A](http://www.newsgator.com/CompanyInfo/FreeClientFAQ.aspx) - details as to upgrades, refunds, etc.
