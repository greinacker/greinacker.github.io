...
comments: []
---
[TUAW has an article up](http://www.tuaw.com/2011/04/20/does-thunderbolt-fortell-the-end-of-the-line-for-the-mac-pro) today wondering if [Thunderbolt](http://www.intel.com/technology/io/thunderbolt/index.htm) might mean the end of the line for the Mac Pro in its current form:
...
Multiple displays make up another area where the MP shines - it's the only Mac where you can have more than two displays (not counting network- or USB-connected displays of dubious performance). I use three (with two video adapters), and I know folks with more. While I could get by with two large 27-30 inch displays myself, there are others who would not be so understanding. As I understand it, Thunderbolt supports one Display Port display at the end of the chain. Seems to me a future MP replacement would ideally need to support at least 4 2560x1600 displays to be accepted by the real power users, so Thunderbolt isn't helping too much here...unless they built in more ports.
