...
While I was just trying to round out some ideas related to the schema and web services [discussion](/gregr/weblog/2002/07/29/sam-ruby-on-loosely-coupled-web-services/) we've been having, I came across this post from Don.  Very pertinent to what we're talking about, relative to extending a schema when it contains xsd:any extensibility elements.
