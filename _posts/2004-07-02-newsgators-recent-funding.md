...
tags: []
---
You've almost certainly heard by now that [NewsGator Technologies](http://www.newsgator.com) has taken on venture funding from [Mobius Venture Capital](http://www.mobiusvc.com). I haven't had a chance to comment about this until now, but there's quite a bit I want to talk about.

First, to the folks that sent their congratulations, thanks!

[Brad Feld](http://www.feld.com/blog/archives/2004/06/why_did_we_inve.html), from Mobius, has written a great post describing why they made the investment. Brad and I have been working together on this for a couple of months now, and he's right on the money in what he says. Go there, and read it now. I'll wait.

NewsGator for Outlook was our first product, and many of you have been with us from [day](/gregr/weblog/2003/02/23/newsgator-10-released/) [one](http://www.newsgator.com/news/archive.aspx?post=1). It's been a great product - tight integration into Outlook, a great story for businesses wanting to leverage RSS, and an amazingly supportive and enthusiastic user base.

Almost exactly [one year later](http://www.newsgator.com/news/archive.aspx?post=29), NewsGator Online Services was launched with a number of exciting capabilities. Synchronization between multiple machines running NewsGator for Outlook. NewsGator editions for web browsers, mobile phones, and email clients besides Outlook. Custom search feeds and premium licensed content rounded out the initial services. Media Center support followed a couple of months later. The motto *"The content you want. Any time. Any place. Any device."* was a primary driving factor for NGOS, and we've been delivering on that ever since.
